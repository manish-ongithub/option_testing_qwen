@echo off
REM ============================================
REM Paper Trade App - Windows Build Script
REM ============================================

echo.
echo ========================================
echo   Paper Trade App Build Script
echo ========================================
echo.
...
if exist "dist\PaperTradeApp" rmdir /s /q dist\PaperTradeApp
...
echo   dist\PaperTradeApp\PaperTradeApp.exe
echo.
echo Next steps:
...
echo      installer\output\PaperTradeApp_Setup_v1.0.exe
echo.
pause
