...
class Aliceblue:
    ...
    # Note: Instance attributes initialized in __init__
    ...
    def __init__(self,
        ...
        # WebSocket related instance attributes
        self.ENC = None
        self.ws = None
    ...
    def unsubscribe(self, instrument):
        ...
        for __instrument in instrument:
            scripts = scripts + __instrument.exchange + "|" + str(__instrument.token) + "#"
            token_key = __instrument.exchange + "|" + str(__instrument.token)
            if token_key in split_subscribes:
                split_subscribes.remove(token_key)
        self.subscriptions = '#'.join(split_subscribes) if split_subscribes else None
